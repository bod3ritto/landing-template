...
export default function DoborSoczewek() {
    return (
        <main className="min-h-screen bg-white">
            ...
            <section className="relative w-full bg-white text-zinc-900" style={{ height: '100vh' }}>
                ...
                <div className="absolute inset-0 z-0 opacity-40 mix-blend-multiply">
                    <Image
                        src="/service_contact_lenses.png"
                        alt="Dobór soczewek"
                        fill
                        priority
                ...
                <div className="absolute inset-0 z-10 flex items-center justify-center px-6 pt-20">
                    <div className="flex flex-col items-center text-center max-w-4xl w-full">
                        ...
                        >
                            Dobór <span className="text-amber-500">Soczewek Kontaktowych</span>
                        </motion.h1>
                        ...
                        >
                            Soczewki kontaktowe to doskonała alternatywa dla okularów, gwarantująca pełną swobodę podczas aktywności fizycznej.
                        </motion.p>
            ...
            <section className="pt-32 pb-48 px-6 bg-white overflow-hidden">
                <div className="container mx-auto max-w-6xl">
                    <div className="max-w-3xl mb-24">
                        ...
                        >
                            Wolność i Swoboda <br />
                            <span className="text-amber-500">Bez Żadnych Ograniczeń</span>
                        </motion.h2>
                        <motion.p
                            initial={{ opacity: 0, y: 20 }}
                        ...
                        >
                            Soczewki kontaktowe to doskonała alternatywa dla tradycyjnych okularów, gwarantująca pełną swobodę i niczym nieograniczone pole widzenia, zwłaszcza podczas aktywności fizycznej.
                        </motion.p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Dobieramy typ soczewki idealnie do budowy Twojego oka, uwzględniając naturalne parametry i tryb Twojego życia."
                            },
                            {
                                title: "Trening Zakładania",
                                desc: "Uczymy bezpiecznej techniki zakładania i zdejmowania soczewek, abyś czuł się pewnie od pierwszego dnia."
                            },
                            {
                                title: "Zdrowie i Higiena",
                                desc: "Wprowadzamy w niezbędne zasady higieny i pielęgnacji, dbając o długofalowe zdrowie Twoich oczu."
                            },
                            {
                                title: "Dla Aktywnych",
                                desc: "Soczewki to idealne rozwiązanie dla osób uprawiających sport, zapewniające stabilny obraz w każdej sytuacji."
                            }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
