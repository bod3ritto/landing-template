...
export default function BadanieWzroku() {
    return (
            ...
            <section className="relative w-full bg-white text-zinc-900" style={{ height: '100vh' }}>
                ...
                <div className="absolute inset-0 z-10 flex items-center justify-center px-6 pt-20">
                    <div className="flex flex-col items-center text-center max-w-4xl w-full">
                        ...
                        >
                            Badanie <span className="text-amber-500">Ostrości Wzroku</span>
                        </motion.h1>
                        ...
                        >
                            Zapewniamy profesjonalne badanie wzroku obejmujące zarówno metody komputerowe, jak i manualne, co pozwala na pełną ocenę wady refrakcji.
                        </motion.p>
            ...
            <section className="pt-32 pb-48 px-6 bg-white overflow-hidden">
                <div className="container mx-auto max-w-6xl">
                    <div className="max-w-3xl mb-24">
                        ...
                        >
                            Precyzyjna Diagnostyka <br />
                            <span className="text-amber-500">Dla Twojego Komfortu</span>
                        </motion.h2>
                        <motion.p
                            initial={{ opacity: 0, y: 20 }}
                        ...
                        >
                            Zapewniamy profesjonalne badanie wzroku obejmujące zarówno metody komputerowe, jak i manualne, co pozwala na pełną ocenę wady refrakcji w naszym nowocześnie wyposażonym gabinecie.
                        </motion.p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
                        {[
                            {
                                title: "Wczesne Wykrywanie",
                                desc: "Regularne badania pozwalają na wykrycie wad i chorób oczu takich jak jaskra czy zaćma na ich wczesnym etapie."
                            },
                            {
                                title: "Trafny Dobór Mocy",
                                desc: "Precyzyjnie określamy parametry potrzebne do wykonania szkieł okularowych lub doboru soczewek kontaktowych."
                            },
                            {
                                title: "Komfort Życia",
                                desc: "Odpowiednia korekcja to nie tylko ostry wzrok, ale także koniec z bólami głowy i szybkim męczeniem się oczu."
                            },
                            {
                                title: "Pełne Bezpieczeństwo",
                                desc: "Dobry wzrok to kluczowy element bezpieczeństwa podczas prowadzenia pojazdów i w codziennej pracy."
                            }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
